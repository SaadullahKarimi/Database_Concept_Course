...
--
-- Host: localhost    Database: clintc
-- ------------------------------------------------------
...
INSERT INTO `diagnose` VALUES (21,'the_is problem');
...
INSERT INTO `docter` VALUES (1,'jaseem','noori',NULL),(2,'jaseem','noori',200);
...
INSERT INTO `patient` VALUES (1,'ruallah','sayed',NULL);
...
CREATE TABLE `specialization` (
  ...
  KEY `id` (`id`),
  CONSTRAINT `specialization_ibfk_1` FOREIGN KEY (`id`) REFERENCES `docter` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2024-11-23 11:11:45
